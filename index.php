            ...
            <div class="row gx-5 align-items-center justify-content-center">
                <div class="col-lg-8 col-xl-7 col-xxl-6">
                    <div class="my-5 text-center text-xl-start">
                        <h1 class="display-5 fw-bolder text-white mb-2">Kumon for Kids
                        </h1>
                        ...
                        <div class="d-grid gap-3 d-sm-flex justify-content-sm-center justify-content-xl-start">
                            <?php
                                if(isset($_SESSION['email'])){
                                    ...
                                    echo '<div class="text-primary fw-bold">Welcome, ' . $email . '</div>';
                                } else {
                                    // User is not logged in, display the "Get Started" and "Login" buttons
                                    echo '<a class="btn btn-primary btn-lg px-4 me-sm-3" href="register.php">Get Started</a>';
                                    echo '<a class="btn btn-outline-light btn-lg px-4" href="login.php">Login</a>';
                                }
                            ?>
                        </div>
                    </div>
                ...
                <div class="col-xl-5 col-xxl-6 d-none d-xl-block text-center"><img class="img-fluid rounded-3 my-5"
                        src="assets/img/anu_sekolah.jpg" alt="..." /></div>
            </div>
        </div>
    </header>
    <!-- Features section-->
        ...
        <div class="container px-5 my-5">
            <div class="row gx-5">
                <div class="col-lg-4 mb-5 mb-lg-0">
                    <h2 class="fw-bolder mb-0">A better way to start future.</h2>
                </div>
                <div class="col-lg-8">
                ...
                <div class="col-lg-10 col-xl-7">
                    <div class="text-center">
                        ...
                        <div class="d-flex align-items-center justify-content-center">
                            <img class="rounded-circle me-3" src="assets/img/profile6.jpg"
                                alt="..." />
                            <div class="fw-bold">
                                Tom Ato
